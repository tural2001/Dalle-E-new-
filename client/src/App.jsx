...
import { Home,CreatePost,CreateTest} from './pages';
  ...
  return (
    <BrowserRouter>
      ...
      sm:px-8 px-4 py-4 border-b border-b-[#e6ebf4]'>
        ...
        <Link to="./create-test" className='font-inter font-medium
        bg-[#6469ff] text-white px-4 py-2 rounded-md'>Create Test</Link>
      </header>
